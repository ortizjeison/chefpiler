...
#line 144 "parser.tab.cc" // lalr1.cc:479
  ...
  // by_state.
  inline
  compilador_parser::by_state::by_state ()
    : state (empty_state)
  {}

  inline
  compilador_parser::by_state::by_state (const by_state& other)
    : state (other.state)
  {}

  inline
  void
  compilador_parser::by_state::clear ()
  {
    state = empty_state;
  }
  ...
  inline
  compilador_parser::by_state::by_state (state_type s)
    : state (s)
  {}

  inline
  compilador_parser::symbol_number_type
  compilador_parser::by_state::type_get () const
  {
  ...
  inline
  compilador_parser::stack_symbol_type::stack_symbol_type (state_type s, symbol_type& that)
  ...
  template <typename Base>
  void
  compilador_parser::yy_print_ (std::ostream& yyo,
...
#line 352 "parser.tab.cc" // lalr1.cc:636
  ...
  inline
  void
  compilador_parser::yypush_ (const char* m, state_type s, symbol_type& sym)
  {
  ...
  inline
  void
  compilador_parser::yypush_ (const char* m, stack_symbol_type& s)
  {
    if (m)
      YY_SYMBOL_PRINT (m, s);
    yystack_.push (s);
  ...
  inline
  void
  compilador_parser::yypop_ (unsigned int n)
  {
    yystack_.pop (n);
  }
  ...
  inline compilador_parser::state_type
  ...
  inline bool
  compilador_parser::yy_pact_value_is_default_ (int yyvalue)
  {
    return yyvalue == yypact_ninf_;
  }

  inline bool
  compilador_parser::yy_table_value_is_error_ (int yyvalue)
  {
...
#line 628 "parser.tab.cc" // lalr1.cc:859
  ...
  std::string
  compilador_parser::yysyntax_error_ (state_type yystate, const symbol_type& yyla) const
  {
...
#undef YYCASE_
  ...
  {
       0,    45,    45,    47,    48,    49,    51,    52,    53,    55
  };

  // Print the state stack on the debug stream.
  void
  compilador_parser::yystack_print_ ()
  {
    *yycdebug_ << "Stack now";
  ...
  void
  compilador_parser::yy_reduce_print_ (int yyrule)
  {
...
#line 996 "parser.tab.cc" // lalr1.cc:1167
#line 57 "parser.yy" // lalr1.cc:1168
