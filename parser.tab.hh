...
#line 127 "parser.tab.hh" // lalr1.cc:377
  ...
  inline
  compilador_parser::token_number_type
  compilador_parser::yytranslate_ (token_type t)
  {
    static
  ...
  inline
  compilador_parser::syntax_error::syntax_error (const location_type& l, const std::string& m)
    : std::runtime_error (m)
    , location (l)
  {}
  ...
  template <typename Base>
  inline
  compilador_parser::basic_symbol<Base>::basic_symbol ()
    : value ()
  {}

  template <typename Base>
  inline
  compilador_parser::basic_symbol<Base>::basic_symbol (const basic_symbol& other)
    : Base (other)
    , value ()
  ...
  template <typename Base>
  inline
  compilador_parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const semantic_type& v, const location_type& l)
    : Base (t)
    , value ()
    , location (l)
  {
  ...
  template <typename Base>
  compilador_parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const location_type& l)
    : Base (t)
    , value ()
    , location (l)
  {}
  ...
  template <typename Base>
  compilador_parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const float v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  inline
  void
  compilador_parser::basic_symbol<Base>::clear ()
  {
    // User destructor.
  ...
  inline
  bool
  compilador_parser::basic_symbol<Base>::empty () const
  {
  ...
  // by_type.
  inline
  compilador_parser::by_type::by_type ()
    : type (empty_symbol)
  {}

  inline
  compilador_parser::by_type::by_type (const by_type& other)
    : type (other.type)
  {}

  inline
  compilador_parser::by_type::by_type (token_type t)
    : type (yytranslate_ (t))
  {}

  inline
  void
  compilador_parser::by_type::clear ()
  {
    type = empty_symbol;
  }
  ...
  inline
  void
  compilador_parser::by_type::move (by_type& that)
  {
    type = that.type;
    that.clear ();
  }
  ...
  inline
  int
  compilador_parser::by_type::type_get () const
  {
    return type;
  }

  inline
  compilador_parser::token_type
  compilador_parser::by_type::token () const
  {
  ...
  compilador_parser::make_FIN (const location_type& l)
  {
